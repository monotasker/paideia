    ...
    m += [(SPAN(T(' Admin'), _class='icon-cog'), False, None,
           [(SPAN(T(' Create'), _class='icon-leaf'), False, None,
            ...
            (SPAN(T(' Reports'), _class='icon-bar-chart'), False, None,
             [(SPAN(T(' Users'), _class='icon-group'), False, URL('listing', 'user')),
              (SPAN(T(' New Bug reports'), _class='icon-warning-sign'), False, URL('editing',
                                        'listing.html', args=['bugs'],
                                        vars={'restrictor': {'bug_status': 5}})),
              (SPAN(T(' Confirmed Bug reports'), _class='icon-stethoscope'), False, URL('editing',
                                        'listing.html', args=['bugs'],
                                        vars={'restrictor': {'bug_status': 1}})),
              (SPAN(T(' All Bug reports'), _class='icon-frown'), False, URL('editing',
                                        'listing.html', args=['bugs'])),
              (SPAN(T(' Paths by tag'), _class='icon-tags'), False, URL('reporting',
                                        'paths_by_tag')),
              (SPAN(T(' Attempt log'), _class='icon-list-alt'), False, URL('reporting',
                                        'attempts')),
              ]),

            (SPAN(T(' Web IDE'), _class='icon-code'), False, URL('admin', 'default', 'index')),

            (SPAN(T(' Database'), _class='icon-sitemap'), False, URL('appadmin', 'index')),
            ])
          ]
