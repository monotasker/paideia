...
1.0
tlast_right	:
datetime.datetime(2014, 3, 20, 1, 25, 25)
tlast_wrong	:
datetime.datetime(2013, 10, 5, 3, 6, 26)
id	:
383419L
in_path	:
None
...
1.0
tlast_right	:
datetime.datetime(2014, 3, 20, 1, 20, 7)
tlast_wrong	:
datetime.datetime(2013, 10, 1, 23, 45, 25)
id	:
383219L
in_path	:
None
...
None
tlast_right	:
datetime.datetime(2013, 9, 27, 14, 8, 27)
tlast_wrong	:
datetime.datetime(2013, 9, 27, 14, 8, 27)
id	:
383119L
...
0.0
tlast_right	:
datetime.datetime(2014, 3, 20, 1, 27, 31)
tlast_wrong	:
datetime.datetime(2013, 9, 26, 20, 57, 36)
id	:
383613L
in_path	:
None
...
18.0
tlast_right	:
datetime.datetime(2014, 3, 17, 22, 29, 3)
tlast_wrong	:
datetime.datetime(2014, 1, 21, 18, 21, 40)
id	:
383116L
in_path	:
None
...
1.0
tlast_right	:
datetime.datetime(2014, 3, 20, 1, 13, 10)
tlast_wrong	:
datetime.datetime(2014, 3, 20, 1, 13, 10)
id	:
383858L
...
1.0
tlast_right	:
datetime.datetime(2014, 1, 24, 23, 32, 23)
tlast_wrong	:
datetime.datetime(2013, 10, 23, 18, 0, 5)
id	:
383978L
in_path	:
None
...
0.0
tlast_right	:
datetime.datetime(2014, 3, 20, 1, 19)
tlast_wrong	:
datetime.datetime(2014, 2, 11, 2, 50, 54)
id	:
383546L
in_path	:
None
...
10.0
tlast_right	:
datetime.datetime(2014, 2, 11, 2, 53, 27)
tlast_wrong	:
datetime.datetime(2013, 10, 3, 21, 37, 10)
id	:
383614L
in_path	:
None
...
None
tlast_right	:
datetime.datetime(2013, 10, 2, 20, 38, 45)
tlast_wrong	:
datetime.datetime(2013, 10, 2, 20, 38, 45)
id	:
384067L
...
None
tlast_right	:
datetime.datetime(2014, 3, 13, 20, 2, 52)
tlast_wrong	:
datetime.datetime(2014, 3, 13, 20, 2, 52)
id	:
383232L
...
datetime.datetime(2014, 3, 20, 1, 25, 25)
tlast_wrong	:
datetime.datetime(2013, 9, 27, 14, 39, 59)
id	:
383916L
in_path	:
None
...
1000.0
tlast_right	:
datetime.datetime(2014, 3, 13, 20, 16, 32)
tlast_wrong	:
datetime.datetime(2013, 11, 20, 0, 24, 20)
id	:
383979L
in_path	:
None
...
1000.0
tlast_right	:
datetime.datetime(2014, 2, 18, 1, 32, 22)
tlast_wrong	:
datetime.datetime(2013, 10, 1, 23, 45, 25)
id	:
383222L
...
0.0
tlast_right	:
datetime.datetime(2014, 3, 20, 1, 11, 17)
tlast_wrong	:
datetime.datetime(2013, 9, 27, 14, 18, 2)
id	:
383890L
in_path	:
None
...
1000.0
tlast_right	:
datetime.datetime(2014, 3, 7, 19, 22, 42)
tlast_wrong	:
datetime.datetime(2013, 11, 2, 2, 13, 11)
id	:
383111L
in_path	:
None
...
1.0
tlast_right	:
datetime.datetime(2014, 3, 20, 1, 25, 26)
tlast_wrong	:
datetime.datetime(2013, 9, 26, 20, 48, 55)
id	:
383217L
in_path	:
None
...
0.0
tlast_right	:
datetime.datetime(2014, 3, 20, 1, 26, 42)
tlast_wrong	:
datetime.datetime(2013, 9, 27, 13, 58, 40)
id	:
383109L
in_path	:
None
...
0.0
tlast_right	:
datetime.datetime(2014, 3, 20, 1, 26, 21)
tlast_wrong	:
datetime.datetime(2013, 9, 26, 20, 45, 36)
id	:
383234L
in_path	:
None
...
datetime.datetime(2014, 3, 20, 1, 25, 26)
tlast_wrong	:
datetime.datetime(2013, 9, 27, 14, 43, 27)
id	:
383117L
in_path	:
None
...
30.0
tlast_right	:
datetime.datetime(2014, 3, 5, 22, 39, 53)
tlast_wrong	:
datetime.datetime(2013, 9, 26, 20, 45, 15)
id	:
383543L
in_path	:
None
...
datetime.datetime(2014, 3, 20, 1, 20, 7)
tlast_wrong	:
datetime.datetime(2013, 10, 3, 21, 19, 34)
id	:
384040L
in_path	:
None
...
0.0
tlast_right	:
datetime.datetime(2014, 3, 20, 1, 16, 1)
tlast_wrong	:
datetime.datetime(2014, 2, 12, 4, 3, 50)
id	:
383112L
in_path	:
None
...
0.0
tlast_right	:
datetime.datetime(2014, 3, 20, 1, 28, 36)
tlast_wrong	:
datetime.datetime(2013, 9, 26, 20, 53, 45)
id	:
383114L
in_path	:
None
...
1.0
tlast_right	:
datetime.datetime(2014, 3, 20, 1, 17, 32)
tlast_wrong	:
datetime.datetime(2013, 10, 1, 21, 10, 31)
id	:
383411L
in_path	:
None
...
1000.0
tlast_right	:
datetime.datetime(2014, 3, 13, 20, 3, 6)
tlast_wrong	:
datetime.datetime(2013, 10, 1, 21, 8, 41)
id	:
383347L
in_path	:
None
...
1.0
tlast_right	:
datetime.datetime(2014, 3, 20, 1, 22, 45)
tlast_wrong	:
datetime.datetime(2013, 9, 30, 13, 52, 55)
id	:
383115L
in_path	:
None
...
datetime.datetime(2014, 3, 20, 1, 25, 26)
tlast_wrong	:
datetime.datetime(2013, 10, 5, 20, 12, 17)
id	:
383118L
in_path	:
None
...
1000.0
tlast_right	:
datetime.datetime(2014, 2, 13, 22, 36, 47)
tlast_wrong	:
datetime.datetime(2013, 9, 27, 14, 41, 6)
