...
"<html><p>Hi %(first_name)s %(last_name)s,</p><p>Greetings from the people at <a href='https://learngreek.ca/paideia'>Paideia</a>! Someone asked to reset the account password for %(email)s. If this was you, click on the link below and enter your new password in the form there. If you didn't request this reset, or you have changed your mind, you can ignore this email and your password will remain unchanged.<p>Reset password link: %(link)s</p> <p>This link will be valid for 48 hours. After that you'll need to request a new one.<p><p>All the best,</p><p>The Paideia people</p></html>": "<html><p>Hi %(first_name)s %(last_name)s,</p><p>Greetings from the people at <a href='https://learngreek.ca/paideia'>Paideia</a>! Someone asked to reset the account password for %(email)s. If this was you, click on the link below and enter your new password in the form there. If you didn't request this reset, or you have changed your mind, you can ignore this email and your password will remain unchanged.<p>Reset password link: %(link)s</p> <p>This link will be valid for 48 hours. After that you'll need to request a new one.<p><p>All the best,</p><p>The Paideia people</p></html>",
...
'Learning New Testament Greek in Context': 'Learning New Testament Greek in Context',
...
'Paideia Password reset requested for %(first_name)s %(last_name)s': 'Paideia Password reset requested for %(first_name)s %(last_name)s',
'Password': 'Contraseña',
